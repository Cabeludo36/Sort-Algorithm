...
int main(int argc, char const *argv[]) {
    int w, h, comps;
    unsigned char* data = stbi_load("Conifer_forest.jpg", &w, &h, &comps, 3); //coloca qual a imagem 
    unsigned char r, g, b;
    printf("%d, %d\n", w, h);
...
/*     size_t img_size = w * h * comps;
    ...
    //stbi_write_png("Shapes_gray.png", w, h, gray_channels, gray_img, w * gray_channels);
 */
    //unsigned char* dato = stbi_load("sky_gray.jpg", &w, &h, &comps, 3);
